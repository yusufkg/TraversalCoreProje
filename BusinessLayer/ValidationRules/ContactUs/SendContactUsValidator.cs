...
namespace BusinessLayer.ValidationRules.ContactUs
{
    public class SendContactUsValidator : AbstractValidator<SendMessageDto>
    {
        public SendContactUsValidator()
        {
            ...
            RuleFor(x => x.Mail).MaximumLength(100).WithMessage("Mail alanına en az 5 karakter veri girişi yapabilirsiniz");
            RuleFor(x => x.Subject).MaximumLength(100).WithMessage("Mail alanına en fazla 100 karakter veri girişi yapabilirsiniz");
        }
    }
}
